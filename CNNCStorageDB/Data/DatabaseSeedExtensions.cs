...
namespace CNNCStorageDB.Data
{
    public static class DatabaseSeedExtensions
    {
        ...
        public static void SeedWorkers(this ModelBuilder modelBuilder)
        {
            ...
            {
                new {Id = 1, FirstName = "Roman",  MiddleName = "Tomecher",   LastName = "Mukolaiovych", Email = "romantomechek@gmail.com",    Phone = "+380678965789", PositionId = 3,  Birthdate = Convert.ToDateTime("12/05/2000"), Salary = 3500, Premium = 0, LocationId = 1},
                new {Id = 2, FirstName = "Oksana", MiddleName = "Stepanchuk", LastName = "Vadymivna",    Email = "oksanastepanchuk@gmail.com", Phone = "+380938965789", PositionId = 5,  Birthdate = Convert.ToDateTime("12/10/1995"), Salary = 1000, Premium = 0, LocationId = 1},
                new {Id = 3, FirstName = "Inna",   MiddleName = "Koltaniuk",  LastName = "Mykolaivna",   Email = "innakoltaniuk@gmail.com",    Phone = "+380938467895", PositionId = 5,  Birthdate = Convert.ToDateTime("06/06/1993"), Salary = 1000, Premium = 0, LocationId = 2},
