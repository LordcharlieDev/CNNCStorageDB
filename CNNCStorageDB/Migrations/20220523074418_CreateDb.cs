        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartTime = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2022, 5, 23, 10, 44, 18, 541, DateTimeKind.Local).AddTicks(3942)),
                    EndTime = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2022, 5, 23, 11, 44, 18, 541, DateTimeKind.Local).AddTicks(4110)),
            ...
            migrationBuilder.InsertData(
                table: "Projects",
                columns: new[] { "Id", "Budget", "EndTime", "FinalPrice", "Name", "StartTime" },
                values: new object[] { 1, 100000, new DateTime(2022, 5, 23, 10, 44, 18, 541, DateTimeKind.Local).AddTicks(4952), 99880, "Phone caller for own workers", new DateTime(2021, 11, 23, 10, 44, 18, 541, DateTimeKind.Local).AddTicks(4949) });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2022, 5, 23, 10, 44, 18, 541, DateTimeKind.Local).AddTicks(4929), "romantomechek@gmail.com", "Roman", "Mukolaiovych", 1, "Tomecher", "+380678965789", 3, 3500 });

            migrationBuilder.InsertData(
                table: "Workers",
                columns: new[] { "Id", "Birthdate", "Email", "FirstName", "LastName", "LocationId", "MiddleName", "Phone", "PositionId", "Salary" },
                values: new object[] { 2, new DateTime(2022, 5, 23, 10, 44, 18, 541, DateTimeKind.Local).AddTicks(4936), "oksanastepanchuk@gmail.com", "Oksana", "Vadymivna", 1, "Stepanchuk", "+380938965789", 5, 1000 });
